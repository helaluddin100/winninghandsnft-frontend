...
contract NFTMarketplace is ERC721URIStorage{
    ...
    function reSallToken(uint256 tokenId, uint256 price) public payable {
        require(idMarketItem[tokenId].owner == msg.sender, "Only item owner can parform this operation");
        require(msg.value == listingPrice, "Price must be equal to listing price");
...
//FUNCTION CREATE MARKETSALE
    ...
    function createMarketSale(uint256 tokenId) public payable{
        ...
        require(msg.value == price, "Please submit te asking price in order to complete the parces");
